...
源文件：`portable/IAR/AtmelSAM7S64/AT91SAM7S64.h`

> 本文件由 `tools/generate_code_markdown.py` 自动生成。内容是面向阅读的代码解说，不会替代源码注释或官方文档。

## 片段 1: 预处理配置 AT91SAM7S64_H
...
**解说：** 这一段定义宏 `AT91C_SYSC_PSTDBY`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。
...
**解说：** 这一段定义宏 `AT91C_SYSC_PROCRST`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。

## 片段 10: 宏 AT91C_SYSC_RTPRES
...
**解说：** 这一段定义宏 `AT91C_SYSC_RTPRES`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。

## 片段 11: 宏 AT91C_SYSC_PIV
...
**解说：** 这一段定义宏 `AT91C_SYSC_PIV`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。

## 片段 12: 宏 AT91C_SYSC_WDRSTT
...
**解说：** 这一段定义宏 `AT91C_SYSC_WDRSTT`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。

## 片段 13: 宏 AT91C_MC_RCB
...
**解说：** 这一段定义宏 `AT91C_US_RSTSTA`。宏在编译前展开，通常用于表达常量、轻量封装、配置开关或平台相关操作。
